    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div
            ...
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Alterar Curso</h2>
            ...
            <form action="{{ route('cursos.update', $curso->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nome"
                        ...
                        placeholder="nome do curso" value="{{ $curso->nome }}" />
                        @error('nome')
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="professor"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="nome do professor" value="{{ $curso->professor }}"/>
                            @error('professor')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                    </div>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3">
                    <div>
                        ...
                        <input type="text" name="valor"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="valor" value="{{$curso->valor}}" />
                            @error('valor')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="vagas"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="numero de vagas" value="{{$curso->vagas}}"/>
                            @error('vagas')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="duracao"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="nr meses" value="{{$curso->duracao}}"/>
                            @error('duracao')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="categoria_id"
                            ...
                            @foreach ($categorias as $categoria)
                                <option value="{{ $categoria->id }}" {{$categoria->id == $curso->categoria_id ? 'selected' : ''}}>{{ $categoria->nome }}</option>
                            @endforeach
                        </select>
                        @error('categoria_id')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                ...
                <button type="submit"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Alterar Curso</button>
            </form>
